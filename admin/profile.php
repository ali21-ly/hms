                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    <?php echo "<img src='img/$profiles' class='col-md-12' style='height: 250px;'>"; ?>
                                    <br><br>
                            ...
                            <div class="col-md-6">
                                ...
                                if (isset($_POST['update_pass'])) {
                                    ...
                                    $new_pass = $_POST['new_pass']; // Fixed typo here
                                ...
                                $show = isset($error['P']) ? "<h5 class='text-center alert alert-danger'>{$error['P']}</h5>" : "";
                                ?>
                                ...
                                <form method="POST">
                                    ...
                                    <input type="submit" name="update_pass" value="Update Password" class="btn btn-success" style="margin-top: 15px;">
                                </form>
                            </div>
                        </div>
                    </div>
